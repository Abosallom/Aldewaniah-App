    ...
    async render(view) {
      ...
      function loadChangelog(wrap) {
        const LOG = [
          ...
          ['v87', '2026-07-04', 'بلوت بأسلوب «كملنا» الأصيل (بعد دراسة اللعب الحقيقي): ورقة «النشرة» في نهاية الجولة، لوحات لاعبين أفقية، شاشة «ضدّ» عند بداية اللعبة', 'Authentic Kamelna-style Baloot (learned from real play): a النشرة round-end sheet, horizontal player plates, a "versus" splash at game start'],
          ['v86', '2026-07-04', 'اقتراح أو بلاغ عطل للمشرف مباشرة من الأقسام + حركة ديناميكية أنيقة في كامل التطبيق', 'Send a suggestion or a bug report to the admin from Sections + elegant dynamic motion across the whole app'],
          ['v85', '2026-07-04', 'بلوت: إصلاح مشاكل التعليق، حماية دور اللاعب (لا لعب تلقائي)، سلسلة الدبل وإعلان المشاريع، بطاقات أوضح', 'Baloot: freeze fixes, protected human turns (no auto-play), the doubling chain & project declarations, clearer cards'],
          ['v84', '2026-07-04', 'إحساس تطبيق أصيل (بدون تحديد نص أو تكبير عرضي أو ومضة لمس) + طاولة سدو بألوان هوية الديوانية', 'An authentic native-app feel (no text selection, double-tap zoom, or tap flash) + a sadu table in the Diwaniah brand colors'],
          ['v83', '2026-07-04', 'بلوت: أبعاد ومقاسات «كملنا» — يد كبيرة، صور مربعة للاعبين، مؤقت دائري، أزرار مناداة واضحة', 'Baloot: Kamelna proportions — a big hand fan, square player avatars, a ring timer, clear bid buttons'],
          ['v82', '2026-07-04', 'أكواد الهدايا: سحب أي كود مُرسَل مع كتابة سبب السحب + إشعار رسمي للعضو', 'Gift codes: withdraw any sent code with a written reason + an official notice to the member'],
          ['v81', '2026-07-04', 'بلوت: شاشة كاملة، رسوم أوراق فاخرة، أصوات وحركة. أكواد الهدايا: إصلاح اختفائها + زر سحب الكل', 'Baloot: full-screen, premium card art, sound & motion. Gift codes: fixed disappearing + a pull-back-all button'],
          ['v80', '2026-07-04', 'الرسائل الخاصة: الأكواد داخل الرسائل تظهر كأزرار نسخ بلمسة واحدة', 'Private messages: codes inside a message show as big one-tap copy chips'],
